        ...
        options: [
          {
            ...
            attrs: { level: 1 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 1 , level_display: '超大标题'}),
          },
          {
            title: '带标题',
            type: state.getSchema().nodes.heading,
            attrs: { level: 2 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 2, level_display: '带标题' }),
          },
          {
            title: '中标题',
            type: state.getSchema().nodes.heading,
            attrs: { level: 3 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 3 , level_display: '中标题'}),
          },
          {
            title: '小标题',
            type: state.getSchema().nodes.heading,
            attrs: { level: 4 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 4 , level_display: '小标题'}),
          },
          {
            title: 'mini标题',
            type: state.getSchema().nodes.heading,
            attrs: { level: 5 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 5 , level_display: 'mini标题'}),
          },
          {
            title: '灰色标题',
            type: state.getSchema().nodes.heading,
            attrs: { level: 6 },
            tooltip: app.translator.trans('askvortsov-rich-text.lib.composer.header_tooltip', { modifierKey, level: 6 , level_display: '灰色标题'}),
          },
          {
            title: '正文',
